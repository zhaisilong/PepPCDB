...
APP_VERSION = "0.8.3"
PDB_SOURCE_SNAPSHOT_DATE = os.environ.get("PEPPCDB_PDB_SOURCE_SNAPSHOT_DATE", "2026-06-17")
...
def stats() -> dict[str, Any]:
    ...
    payload["affinity_entries"] = len(manual.get("affinity_entries") or [])
    payload["target_cards"] = manual.get("target_card_count", 0)
    payload["pep_annotations"] = manual.get("pep_annotation_count", 0)
    return payload
